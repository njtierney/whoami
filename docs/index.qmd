...
-   **2021 - 2024**: **Research Software Engineer** \@ The Kids Research Institute Australia

    -   Maintain and design R packages: [`greta`](), [`conmat`]()
    

# Hiking! njt.micro.blog
...
-   3 - 4:
    -   [Citing Figures](https://qmd4sci.njtierney.com/cite-fig-tab-sec.html) / [Managing References](https://qmd4sci.njtierney.com/citations-and-styles.html)
    -   [Common problems](https://qmd4sci.njtierney.com/common-problems.html) / AMA
